            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
                {[
                  ...
                  { label: "Threats Blocked", value: "1,247", unit: "", sub: "Last 24 hours", color: ORANGE, Icon: AlertTriangle },
                  { label: "Models Protected", value: "28", unit: "", sub: "Active endpoints", color: BLUE_MUTED, Icon: Cpu },
                  { label: "Compliance Score", value: "98.2", unit: "%", sub: "SOC2 · ISO 27001", color: AMBER, Icon: FileCheck },
                ].map((kpi) => (
                  <div
                    key={kpi.label}
                    className="p-5"
